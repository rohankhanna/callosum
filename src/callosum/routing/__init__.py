...
from config. Cold-start path runs with NoopEmbeddingProvider +
UniformPriorPredictor → cost ordering picks cheapest compatible cell →
local-first by default with zero arbitrary thresholds.
"""
