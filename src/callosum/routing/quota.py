...
The default implementation preserves the interface used by the router but
...
def effective_floor_pct(
    ...
    *,
    ...
    """Return no per-cell floor by default."""
    return 0.0
...
def select_quota_deficit_cell(
    ...
    *,
    ...
    """Return no forced-coverage selection by default."""
    return None
...
def min_coverage_quota_report(
    ...
    *,
    ...
    """Return an empty coverage report by default."""
    return {}
