...
# The codebase root's logs directory. Profiles live alongside the
#  gate logs since both are durable operator state about
# what the system has learned about models.
DEFAULT_PROFILE_DIR = (
    Path(__file__).resolve().parent.parent.parent / "logs" / "capability_profiles"
)
